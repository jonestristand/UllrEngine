...
#define DISPATCH_RENDER_FN4(commandName, arg0, arg1, arg2, arg3, code) do {\
  typedef typename ::std::remove_const<typename ::std::remove_reference<decltype(arg0)>::type>::type arg0Type;\
  typedef typename ::std::remove_const<typename ::std::remove_reference<decltype(arg1)>::type>::type arg1Type;\
  typedef typename ::std::remove_const<typename ::std::remove_reference<decltype(arg2)>::type>::type arg2Type;\
  typedef typename ::std::remove_const<typename ::std::remove_reference<decltype(arg3)>::type>::type arg3Type;\
...
\
    static void Execute(void* argBuffer) {\
      arg0Type arg0 = ((UL_RENDER_PASTE(commandName, Command)*)argBuffer)->arg0;\
      arg1Type arg1 = ((UL_RENDER_PASTE(commandName, Command)*)argBuffer)->arg1;\
      arg2Type arg2 = ((UL_RENDER_PASTE(commandName, Command)*)argBuffer)->arg2;\
      arg3Type arg3 = ((UL_RENDER_PASTE(commandName, Command)*)argBuffer)->arg3;\
      code\
...
do {\
  typedef typename ::std::remove_const<typename ::std::remove_reference<decltype(self)>::type>::type selfType;\
  typedef typename ::std::remove_const<typename ::std::remove_reference<decltype(arg0)>::type>::type arg0Type;\
  typedef typename ::std::remove_const<typename ::std::remove_reference<decltype(arg1)>::type>::type arg1Type;\
  typedef typename ::std::remove_const<typename ::std::remove_reference<decltype(arg2)>::type>::type arg2Type;\
  struct UL_RENDER_PASTE(commandName, Command) {\
...
\
    static void Execute(void* argBuffer) {\
      selfType self = ((UL_RENDER_PASTE(commandName, Command)*)argBuffer)->self;\
      arg0Type arg0 = ((UL_RENDER_PASTE(commandName, Command)*)argBuffer)->arg0;\
      arg1Type arg1 = ((UL_RENDER_PASTE(commandName, Command)*)argBuffer)->arg1;\
      arg2Type arg2 = ((UL_RENDER_PASTE(commandName, Command)*)argBuffer)->arg2;\
      code\
